...
?>
        <div class="wrap meta-ranker-activation-page">
				...
				<p id="messager" class="description"><?= __('One more minute, please accept our Terms & Conditions!', 'meta-ranker') ?></p>
				...
				<form method="POST" action="">
					...
					<label>
						...
						<span><?= sprintf(__('I agree to the %sTerms & Conditions%s.', 'meta-ranker'), '<a href="' . admin_url('edit.php?post_type=meta-ranker&page=meta-ranker-settings#tab=terms-of-use') . '" target="_blank">', '</a>') ?></span>
					</label>
